                                                ...
                                                {editTab === 'settings' ? (
                                                    <div className="flex-1 w-full bg-slate-50 border border-[#cbd5e1] rounded-lg overflow-y-auto custom-scroll p-4 shadow-inner flex flex-col gap-6">
                                                        ...
                                                        {textMatches.length > 0 && (
                                                            <div>
                                                                <h3 className="text-[10px] font-bold text-slate-500 mb-3 uppercase tracking-widest border-b border-slate-200 pb-2">Ekstraksi Teks</h3>
                                                        ...
                                                        <h3 className="text-[10px] font-bold text-slate-500 mb-0.5 uppercase tracking-widest border-b border-slate-200 pb-2">Pemilihan Thumbnail</h3>
                                                        <div className="flex flex-wrap gap-3 p-3 bg-white border border-slate-200 rounded-lg shadow-sm">
